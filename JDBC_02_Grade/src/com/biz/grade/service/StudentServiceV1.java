...
public class StudentServiceV1 extends StudentService {
	...
	@Override
	public int insert(StudentDTO dvo) {
	...
	public List<StudentDTO> findByName(String name) {
		...
		try {
			...
			while (rst.next()) {
				...
				/*
				 * StudentDTO.builder() .st_num(rst.getString("ST_NUM"))
				 * .st_name(rst.getString("ST_NAME")) .st_addr(rst.getString("ST_ADDR"))
				 * .st_grade(rst.getInt("ST_GRADE")) .st_tel(rst.getString("ST_TEL"))
				 * .st_dept(rst.getString("ST_DEPT")) .build()
				 */);
			}
			rst.close();
			dbConn.close();
	...
	@Override
	public int update(StudentDTO svo) {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	private StudentDTO rstTOdto(ResultSet rst) throws SQLException {
		return StudentDTO.builder().st_num(rst.getString("ST_NUM")).st_name(rst.getString("ST_NAME"))
				.st_addr(rst.getString("ST_ADDR")).st_grade(rst.getInt("ST_GRADE")).st_tel(rst.getString("ST_TEL"))
				.st_dept(rst.getString("ST_DEPT")).build();
	}
}
